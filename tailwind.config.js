  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "glow-mint-xs": "0 0 20px rgba(52, 211, 153, 0.15)",
        "glow-mint-sm": "0 0 20px rgba(52, 211, 153, 0.2)",
        "glow-mint-md": "0 0 30px rgba(52, 211, 153, 0.25)",
        "glow-mint-lg": "0 0 40px rgba(52, 211, 153, 0.25)",
        "glow-mint-fab": "0 0 24px rgba(52, 211, 153, 0.35)",
        "glow-mint-active": "0 0 20px rgba(52, 211, 153, 0.5)",
